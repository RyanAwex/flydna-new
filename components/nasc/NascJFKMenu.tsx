...
export default function NascJFKMenu({ onClose, anchorX = 100, anchorY = 200, side = 'right' }: JFKMenuProps) {
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes jfkLineDraw {
          from { stroke-dashoffset: 1200; }
          to   { stroke-dashoffset: 0; }
        }
        @keyframes jfkScoreGlow {
          0%,100% { opacity: 0.8; }
          50%     { opacity: 1; }
        }
        @keyframes jfkItemIn {
        ...
        @keyframes jfkSpotPulse {
          0%,100% { opacity:0.6; }
          50%     { opacity:1; }
        }
        @keyframes jfkConnBreath {
          0%,100% { opacity:1; }
          50%     { opacity:0.55; }
        }
      `}</style>

      {/* Animated connector line from logo to card */}
      <svg style={{
        position: 'absolute', top: 0, left: 0,
        width: '100%', height: '100%',
        ...
        <path
          ...
          style={{ animation: 'jfkLineDraw 0.9s cubic-bezier(0.16,1,0.3,1) forwards, jfkConnBreath 2.5s ease-in-out infinite 1s' }}
        />
      </svg>
      ...
      <div style={{
        ...
        width: '240px',
        pointerEvents: 'auto',
        animation: 'jfkCardIn 0.45s cubic-bezier(0.16,1,0.3,1) forwards',
        animationDelay: '0.4s',
        opacity: 0,
      }}>
        <div className="glass-panel-heavy" style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
              <div style={{
                ...
                <img src="/JFK.png" alt="JFK" style={{ width: 28, height: 28, objectFit: 'contain' }} />
              </div>
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{
                ...
                animation: 'jfkScoreGlow 3s ease-in-out infinite',
              }}>
                312 <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '14px' }}>/</span> 298
              </div>
              <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
              <div style={{
                ...
                <img src="/Delta.png" alt="Delta" style={{ width: 28, height: 28, objectFit: 'contain' }} />
              </div>
          ...
          <div style={{
            ...
            animation: 'jfkSpotPulse 2.5s ease-in-out infinite',
          }} />
            ...
            {menuItems.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  animation: 'jfkItemIn 0.3s ease forwards',
